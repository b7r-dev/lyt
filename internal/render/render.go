...
import (
	...
	"github.com/b7r-dev/lyt/internal/markdown"
)
...
func (r *Renderer) renderNav(currentSlug string) string {
	...
	githubLink := `<a href="https://github.com/b7r-dev/lyt" class="nav-github" target="_blank" rel="noopener" aria-label="GitHub">
	...
	sb.WriteString(fmt.Sprintf(`<a href="https://github.com/b7r-dev/lyt" class="nav-mobile-link" target="_blank" rel="noopener">GitHub</a>`))
	sb.WriteString(`</div>`)
